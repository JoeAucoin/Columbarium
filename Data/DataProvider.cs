...
namespace GIBS.Modules.Columbarium.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "GIBS.Modules.Columbarium.Data.SqlDataprovider,Columbarium";
        ...
        public abstract IDataReader GetSections();
        public abstract IDataReader GetDisplaySection(int displaySection);
        public abstract IDataReader GetNiche(int nicheID);
        public abstract int InsertReservation(ColInfo ci);
        public abstract void DeleteReservation(int nicheID);
        public abstract IDataReader Search(string lastName);
        public abstract int UpdateReservation(ColInfo ci);
        public abstract int UpdateNichePrice(ColInfo ci);
        public abstract IDataReader SearchPending();
        #endregion
